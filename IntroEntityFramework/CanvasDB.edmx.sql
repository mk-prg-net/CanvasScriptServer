...
-- --------------------------------------------------
-- Date Created: 05/09/2016 15:11:30
-- Generated from EDMX file: C:\Users\marti_000\Documents\prj\NET\C#\CanvasScriptServer\IntroEntityFramework\CanvasDB.edmx
-- --------------------------------------------------
...
CREATE TABLE [dbo].[UsersSet] (
    [Id] int IDENTITY(1,1) NOT NULL,
    [Created] datetime  NOT NULL,
    [UserNamesSet_Name] nvarchar(256)  NOT NULL
);
GO
...
-- Creating foreign key on [UserNamesSet_Name] in table 'UsersSet'
ALTER TABLE [dbo].[UsersSet]
ADD CONSTRAINT [FK_UserNamesUsers]
    FOREIGN KEY ([UserNamesSet_Name])
    REFERENCES [dbo].[UserNamesSet]
        ([Name])
